  ...
  return (
    <div className="w-full flex justify-center ">
      <div className="text-poppins text-center w-[80%] text-white">
        ...
        evolving cyber threats, odds are that your organization is exposed to a
        much higher risk, especially if it is short of talent who has the right
        set of strategies, experience and skills to mitigate the risk.
        <br></br> <br></br>
